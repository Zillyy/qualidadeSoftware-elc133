...
public class TestRandomGenerator extends TestCase
{
    ...
    {
        assertTrue("First random number should be the same",
            generator1.extract(100000) == generator2.extract(100000));
    }


    private void extractTenHundredNumbers(RandomGeneratorInterface one,
        RandomGeneratorInterface two)
    {
    ...
    public void testNextRandomAfterTenHundred()
    {
        ...
        for(int i = 0; i < 1000; ++i)
        {
            assertTrue("Next random number should be the same",
                generator1.extract(100000) == generator2.extract(100000));
        }
    }
